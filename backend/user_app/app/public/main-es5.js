...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot(appRoutes, {
        enableTracing: false
      } // <-- debugging purposes only
      ), _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_8__["MatToolbarModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_9__["MatIconModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_10__["MatListModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_11__["MatSidenavModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_13__["MatSelectModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_14__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["ReactiveFormsModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AppModule, {
        ...
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_8__["MatToolbarModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_9__["MatIconModule"], _angular_material_list__WEBPACK_IMPORTED_MODULE_10__["MatListModule"], _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_11__["MatSidenavModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_12__["MatButtonModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_13__["MatSelectModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_14__["MatFormFieldModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_15__["ReactiveFormsModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  function srcAppComponentsHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_database_access_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../services/database-access.service */
    ...
    function HomeComponent_select_9_option_1_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function HomeComponent_select_9_Template(rf, ctx) {
      if (rf & 1) {
        var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "select", 9);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HomeComponent_select_9_Template_select_ngModelChange_0_listener($event) {
          ...
          return ctx_r5.allFilters[i_r2] = $event;
        });
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(dbService) {
        _classCallCheck(this, HomeComponent);

        this.dbService = dbService;
        this.layerGroup = new leaflet__WEBPACK_IMPORTED_MODULE_1__["LayerGroup"]();
        this.allFilters = ["morning", "spring", "male", "adult", "citizen"];
        this.filters = [{
          name: "Time section",
          value: "time",
          options: [{
            value: "morning",
            viewValue: "6:00h - 13:00h"
          }, {
            value: "afternoon",
            viewValue: "13:00h - 21:00h"
          }, {
            value: "night",
            viewValue: "21:00h - 6:00h"
          }]
        }, {
          name: "Season",
          value: "season",
      ...
      _createClass(HomeComponent, [{
        ...
        key: "toGeoJson",
        value: function toGeoJson(segment) {
          var geojson = {};
        ...
        key: "paintSegment",
        value: function paintSegment(segment, emotion) {
          leaflet__WEBPACK_IMPORTED_MODULE_1__["geoJSON"](segment, {
        ...
        value: function buildSegments() {
          ...
          this.dbService.getEmotionsFiltered(this.filter).subscribe(function (res) {
            res['data'].forEach(function (segment) {
              var mostRepeated = 0;
              ...
              _this.dbService.getSegmentByWay(segment._id).subscribe(function (res) {
                _this.paintSegment(res['coordinates'], emotion);
              }, function (err) {
                console.log("Error at getSegmentByWay");
              });
            });

            _this.layerGroup.addTo(_this.map);
          }, function (err) {
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_database_access_service__WEBPACK_IMPORTED_MODULE_2__["DatabaseAccessService"]));
    };
    ...
    HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 13,
      vars: 1,
      consts: [["lang", "es"], ["rel", "stylesheet", "href", "http://cdn.leafletjs.com/leaflet/v0.7.7/leaflet.css"], [1, "header"], [1, "toolbar"], [1, "title"], [1, "selectors"], ["class", "filter", 3, "ngModel", "ngModelChange", 4, "ngFor", "ngForOf"], [3, "click"], ["id", "map"], [1, "filter", 3, "ngModel", "ngModelChange"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]],
      ...
      directives: [_angular_material_toolbar__WEBPACK_IMPORTED_MODULE_3__["MatToolbar"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["SelectControlValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgModel"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["NgSelectOption"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ɵangular_packages_forms_forms_x"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          type: _services_database_access_service__WEBPACK_IMPORTED_MODULE_2__["DatabaseAccessService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppServicesDatabaseAccessServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DatabaseAccessService", function () {
    ...
    var DatabaseAccessService = /*#__PURE__*/function () {
      function DatabaseAccessService(http) {
        _classCallCheck(this, DatabaseAccessService);

        this.http = http;
      }

      _createClass(DatabaseAccessService, [{
        key: "getAllEmotions",
        value: function getAllEmotions() {
          return this.http.get(apiURL + '/getAllEmotions', {
            responseType: 'json'
          });
        }
      }, {
        key: "getSegmentByWay",
        value: function getSegmentByWay(way) {
          return this.http.get(apiURL + '/getSegmentByWay/' + way, {
            responseType: 'json'
          });
        }
      }, {
        key: "getEmotionsFiltered",
        value: function getEmotionsFiltered(filter) {
          return this.http.get(apiURL + '/getEmotionsFiltered/' + filter, {
            responseType: 'json'
          });
        }
      }]);
    ...
    DatabaseAccessService.ɵfac = function DatabaseAccessService_Factory(t) {
      return new (t || DatabaseAccessService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]));
    };

    DatabaseAccessService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
      token: DatabaseAccessService,
      factory: DatabaseAccessService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DatabaseAccessService, [{
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Sergio\Desktop\emotionalMaps\backend\user_app\frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
